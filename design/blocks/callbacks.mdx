...
<Note>
    Positional arguments are only supported in Bigbytes versions `>= 0.8.81`.
</Note>
...
![Block callback](https://github.com/getbigbytes/assets/blob/main/block-callback.png?raw=True)
