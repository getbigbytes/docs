---
title: "Algolia Integration in Bigbytes"
sidebarTitle: "Algolia Integration in Bigbytes"
---

## Credentials Configuration

Open the file named `io_config.yaml` at the root of your Bigbytes project and enter required fields:
