...
sidebarTitle: "Okta"
icon: "sun-bright"
description: "Enable signing in with Okta in Bigbytes."
---
...
You will need to add Bigbytes as an OAuth client in your Okta organization admin dashboard.
...
Make sure you select the "Authorization Code" grant flow, and add `http(s)://<your-bigbytes-url>/oauth` as a Sign-in redirect URI.
...
You should now see the "Sign in with Okta" button when you start Bigbytes and attempt to sign in.

<Frame>
    <img
        alt="Sign in with Okta"
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/sign-in-with-okta.png?raw=true"
    />
</Frame>
