...
Configuring a development environment can be _hard_, but at Bigbytes we're trying to make things as simple and straightforward as possible.
...
<Step title="Configure your development environment">
   Configure your coding environment for local development: `pyenv`, pre-commit hooks, etc. Follow the instructions [here](https://github.com/getbigbytes/bigbytes/blob/master/README_dev.md).
</Step>
...
Once your environment is configured, you can make edits and see changes in real time! Now you're ready to contribute to the Bigbytes repo. This is very similar to contributing to other open source projects on GitHub.
...
Otherwise, follow the steps below to push your code changes to the Bigbytes repo.
...
You can check the `bigbytes/frontend/scripts/install_and_run.sh` file in VSCode to see if
...
<img src="https://github.com/getbigbytes/assets/blob/main/development/windows/update-crlf-to-lf-vscode.gif?raw=True"/>
