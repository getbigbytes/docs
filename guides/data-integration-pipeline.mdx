...
You must run Bigbytes using [Docker](/getting-started/setup#using-docker) because there are a lot of
...
1. Open Bigbytes in your browser and click the **`[+ New pipeline]`** button.
