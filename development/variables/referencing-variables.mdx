---
title: "Accessing variables in Bigbytes"
...
Bigbytes allows users to interpolate variables specific to your [pipeline](/getting-started/runtime-variable) or [project](/development/variables/environment-variables). The following syntax is specific to `yaml` and `SQL` files.
...
| `{{ mage_secret_var('secret') }}`   | Get secret from [Bigbytes secrets](/development/variables/secrets).                        |
