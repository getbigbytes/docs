...
description: Scheduled deliveries let you send a dashboard or saved chart, and their results to people via email or Slack - even to people who don't have an account in your Bigbytes instance.
---



If your Bigbytes organization has [Slack](/guides/adding-slack-integration) set up, you can create or select an existing saved chart or dashboard, add a scheduled delivery to it, and tell Bigbytes when you’d like the send out your update. You can set up as many scheduled deliveries to a saved chart or dashboard as you like, and if you make any changes to the content, Bigbytes will update the scheduled deliveries the next time they’re sent.
...
## Enabling scheduled deliveries[](#enabling-scheduled-deliveries "Direct link to Enabling scheduled deliveries")

Emailed scheduled deliveries are available on all Bigbytes Cloud plans.

To set up Slack, an organization admin will have to [add the Slack integration](/guides/adding-slack-integration).

## Creating a scheduled delivery[](#creating-a-scheduled-delivery "Direct link to Creating a scheduled delivery")

Only users with [admin, developer or edit access](/references/roles) can create scheduled deliveries. To create a scheduled delivery, click on the three-dot menu in the top-right corner of your chart or dashboard, then click on `scheduled deliveries`.

<Frame>
  <img src="" alt=""/>
</Frame>
![](/images/guides/scheduled-deliveries-three-dot-menu-922af4a879c906642fe00d5660fc0b9b.png)
...
![](/images/guides/scheduled-deliveries-create-new-modal-27e285f1ea9a5aa7118e713175758a7c.png)
...
![](/images/guides/configure-scheduled-delivery-39a01495ad991f4e977d57ba31f37271.png)

#### Delivery name[](#delivery-name "Direct link to Delivery name")

This is the name of your scheduled delivery. This name will appear as the header in your scheduled delivery message.

#### Delivery frequency[](#delivery-frequency "Direct link to Delivery frequency")
...
#### Send to[](#send-to "Direct link to Send to")
...
![](/images/guides/scheduled-delivery-dashboard-filters-e608febd4f3d0edf3108cb8e43f937ad.png)
...
<Frame>
  <img src="/images/guides/scheduled-delivery-customization-bff8b45b37d11ead29b064e1bdf4e6b9.png" alt=""/>
</Frame>


Finally, you can customize the message that gets sent with your scheduled delivery on the `Customization` tab.

## Editing and deleting your scheduled deliveries[](#editing-and-deleting-your-scheduled-deliveries "Direct link to Editing and deleting your scheduled deliveries")
...
<Frame>
  <img src="/images/guides/edit-delete-scheduled-delivery-0cf24006486d5038ba242f37cd682187.png" alt=""/>
</Frame>


## Overview of your scheduled deliveries[](#overview-of-your-scheduled-deliveries "Direct link to Overview of your scheduled deliveries")
...
<Frame>
  <img src="/images/guides/scheduled-deliveries-overview-4d01e9ce6fd3066699b1ded117a86497.png" alt=""/>
</Frame>


## Sending to private Slack channels[](#sending-to-private-slack-channels "Direct link to Sending to private Slack channels")
...
You must add the Bigbytes slack bot into the private Slack channel for it to be able to post scheduled delivery results.

## Configuring the default time zone[](#configuring-the-default-time-zone "Direct link to Configuring the default time zone")
...
<Frame>
  <img src="/images/guides/project-default-time-zone-6934eca82e7b3a4e03ee345cf461d782.jpg" alt=""/>
</Frame>
