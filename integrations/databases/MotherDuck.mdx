...
---
<div align="center">
<img src="https://github.com/getbigbytes/getbigbytes/assets/59450879/0e410c12-73a0-43d8-97fe-396772d2767b" width="60%"/>
</div>

<Note>
The MotherDuck intergration is supported in Bigbytes versions `>=0.9.63`
</Note>

## Credentials

Open the file named `io_config.yaml` at the root of your Bigbytes project and enter DuckDB database name & schema.
