...
description: "Enable signing in with a Microsoft account in Bigbytes."
---

### Pre-requisites

First, you'll need to enable user authentication within Bigbytes. You can find out more about
...
own Microsoft Entra ID, or use the default Bigbytes application. We recommend registering your own application unless
there is a specific reason you cannot do so.

<AccordionGroup>

<Accordion title="Register and use your own Bigbytes application">
...
<Frame>
    <img
        ...
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad.png?raw=true"
    />
</Frame>
</Step>
...
<Frame>
    <img
        ...
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-app-registrations.png?raw=true"
    />
</Frame>
</Step>

<Step title="Register a new application for Bigbytes">
...
<Frame>
    <img
        ...
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-new-registration.png?raw=true"
    />
</Frame>

Make sure you add the following web redirect URI: `http(s)://<your-bigbytes-url>/oauth`.
...
<Frame>
    <img
        ...
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-certificates.png?raw=true"
    />
</Frame>
...
<Frame>
    <img
        alt="Copy values"
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-application-fields.png?raw=true"
    />
</Frame>
...
You should now see the "Sign in with Microsoft" button when you start Bigbytes and attempt to sign in.
You may need to restart your Bigbytes server for the changes to take effect.

<Frame>
    <img
        alt="Sign in with Microsoft"
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/sign-in-with-microsoft.png?raw=true"
    />
</Frame>
...
<Accordion title="Use the default Bigbytes application">
...
<Frame>
    <img
        ...
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-properties.png?raw=true"
    />
</Frame>
</Step>
...
<Frame>
    <img
        ...
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-tenant-id.png?raw=true"
    />
</Frame>
</Step>
...
You can map Active Directory roles to Bigbytes roles by setting the `ACTIVE_DIRECTORY_ROLES_MAPPING` environment variable.
The value should be a JSON object with the AD role as the key and the name of the Bigbytes role as the value. For example:

`export ACTIVE_DIRECTORY_ROLES_MAPPING='{"Bigbytes.Edit": "Editor", "Bigbytes.Admin": "Admin"}'`
...
<Frame>
    <img
        alt="App roles"
        src="https://github.com/getbigbytes/assets/blob/main/production/authentication/ad-app-role-value.png?raw=true"
    />
</Frame>

When a user signs in for the first time with their Microsoft account, Bigbytes will use this mapping to automatically add
