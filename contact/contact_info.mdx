---
title: Contact Us
description: "There are a few ways you can get in touch with the team. Here's which one to use depending on your situation:"
---

## I want to report a bug or submit a feature request

Woo, thanks for helping out! You can [create a new issue in GitHub](https://github.com/getbigbytes/bigbytes/issues) and the team will get back to you ASAP <Icon icon="face-smile" iconType="solid"/>
...
2. Sending an email to support@getbigbytes.com
...
<Frame>
  <img src="/images/contact/star_github_action-065ae77ee1f786df7b070227514b6cde.png"/>
</Frame>
3. [Sign up to our newsletter](https://www.getbigbytes.com/#wf-form-email-form) at the bottom of the home page (we send out regular updates of all the fun things we've been up to!)
...
5. Send us an email at support@getbigbytes.com
