...
description: With Bigbytes, you can have a single organization (e.g. Bigbytes), and multiple projects within that organization (e.g. Production, Jaffle Shop, etc.)
---
...
Not sure what it all means? Don't worry, we've written [a step-by-step guide](/get-started/setup-bigbytes/connect-project) that will help you out.
