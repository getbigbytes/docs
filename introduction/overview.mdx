...
<CardGroup cols={2}>
  <Card
    href={`${urls.pro}?source=introduction`}
    horizontal
  >
    <div
      style={{
    ...
    >
      <div style={{ marginRight: 16 }}>
        <img
          src="https://github.com/getbigbytes/assets/blob/main/oss/card-pro.png?raw=true"
          noZoom
        />
      </div>
  ...
  <Card
  href={`${urls.oss}?source=introduction`}
    horizontal
  >
    <div
      style={{
    ...
    >
      <div style={{ marginRight: 16 }}>
        <img
          src="https://github.com/getbigbytes/assets/blob/main/oss/card-oss.png?raw=true"
          noZoom
        />
      </div>
      <div style={{ marginTop: 8 }}>
...
<CardGroup>
  ...
  <Card
    ...
    href="https://demo.getbigbytes.com"
    horizontal
  >
...
## Ingest data in few clicks

We put the _fun_ in fun-ctional programming. Bigbytes is a hybrid framework that combines the best of both worlds: the flexibility of notebooks with the rigor of modular code.
...
<Steps titleSize="h2">
  <Step title="🔨 Build">
    ...
    <p align="center">
      <img src="https://github.com/getbigbytes/assets/blob/main/overview/bigbytes-build.gif?raw=True"/>
    </p>
  </Step>
  <Step title="🔍 Preview">
  ...
  <p align="center">
    <img src="https://github.com/getbigbytes/assets/blob/main/overview/bigbytes-preview.gif?raw=True"/>
  </p>
</Step>
<Step title="🚀 Launch" >
  Don't have a large team dedicated to Airflow? Bigbytes makes it easy for a single developer or small team to scale up and manage thousands of pipelines.

  - **Fast deploy**: Deploy Bigbytes to [AWS](/production/deploying-to-cloud/aws/setup), [GCP](/production/deploying-to-cloud/gcp/setup), or [Azure](/production/deploying-to-cloud/azure/setup) with only 2 commands using maintained Terraform templates.
  ...
  <p align="center">
    <img src="https://github.com/getbigbytes/assets/blob/main/overview/observability.gif?raw=True"/>
  </p>
</Step>
</Steps>
...
| 🧱   | [dbt](/dbt)                                                      | Build, run, and manage your dbt models with Bigbytes.                      |
...
These are the fundamental concepts that Bigbytes uses to operate.
|          |                                                        |                                                                                                                                                             |
| -------- | ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| 🤓      | [Data product](/design/core-abstractions#data-product) | Every block produces data after it's been executed. These are called data products in Bigbytes.                                                                 |
...
Individually, we're a bigbytes.

> 🧙 Bigbytes
>
> Magic is indistinguishable from advanced technology. A bigbytes is someone who
> uses magic (aka advanced technology).

Together, we're Bigbyters!

> 🧙‍♂️🧙 Bigbyters (`/ˈmājər/`)
>
> A group of bigbytes who help each other realize their full potential! Join us on [Slack](https://www.getbigbytes.com/chat).
...
<p align="center">
  <a href="https://github.com/getbigbytes/bigbytes/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=getbigbytes/bigbytes&columns=10" />
  </a>
</p>
...
<p align="center">
  <img src="https://github.com/getbigbytes/assets/blob/main/mascots/mascots-shorter.jpeg?raw=true" noZoom />
</p>
