...
If you want to use other ODBC Driver versions, you'll need to build a custom docker image (use Bigbytes image as the base image) and install the drivers.
...
- [Windy Martin](https://bigbytes.slack.com/archives/C068SHY6YG6/p1705874712639659?thread_ts=1705668895.141169&cid=C068SHY6YG6)
