---
title: "Filtering a Dashbaord in the URL"
---
...
## Example of dashboard URL Filtering[](#example-of-dashboard-url-filtering "Direct link to Example of dashboard URL Filtering")
...
## Setting up dashboard URL filtering[](#setting-up-dashboard-url-filtering "Direct link to Setting up dashboard URL filtering")
...
<Frame>
  <img src="/images/guides/dashboard-url-filter-4eb115b7e180529d7a5d50343d500743.png" alt=""/>
</Frame>
...
2. Paste that URL into the YAML file for the model you're working in. See an [example in our demo project here](https://github.com/getbigbytes/bigbytes-demo-data-gardening/blob/5632406cb5b43fdf066a2086142dc3e86a41e947/dbt/models/dbt%5Forders.yml#L31-L32).
