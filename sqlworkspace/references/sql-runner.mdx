...
<Frame>
  <img src="/images/references/assets/images/access-sql-runner-e299a63e83e2ecb4b3b09c64f94211be.jpg"/>
</Frame>

Once you're in the SQL Runner, you'll see four key components:

1. A list of tables in your data warehouse that Bigbytes has access to (based on your data warehouse connection in Bigbytes).
2. The schema of a selected table.
3. The SQL query builder.
4. The results from your latest SQL query.

<Frame>
  <img src="/images/references/assets/images/sql-runner-components-60eb488682b46fb2ecedad92a2656adb.jpg"/>
</Frame>
...
<Frame>
  <img src="/images/references/assets/images/query-history-3c6295f2352f2d118474de3a51d83fd7.jpg"/>
</Frame>

Once you've run your query, you can either:

1. [Build and save a **Chart**](#building-charts-in-the-sql-runner)
2. [Create a **Virtual View** so your query becomes a reusable table in Bigbytes](/references/virtual-views)
...
<Frame>
  <img src="/images/references/assets/images/build-chart-sql-runner-72c3e95c8e37b83f48189599e25ddba1.jpg"/>
</Frame>
