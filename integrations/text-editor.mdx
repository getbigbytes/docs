...
Each pipeline is represented by a YAML file in a folder named `pipelines/` under the Bigbytes
project directory.
...
<Frame>
    <img
        alt="Sample pipeline"
        src="https://github.com/getbigbytes/assets/blob/main/data-pipeline-overview.png?raw=True"
    />
</Frame>
