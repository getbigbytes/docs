...
## General filters tips[](#general-filters-tips "Direct link to General filters tips")

Here are some general tips about filters that apply to using them in both the Explore view and in dashboards.

### If you want to have multiple filters, just click `+ Add filter`[](#if-you-want-to-have-multiple-filters-just-click--add-filter "Direct link to if-you-want-to-have-multiple-filters-just-click--add-filter")
...
### If you add multiple filters, you can choose to have `ALL` or `ANY` of the conditions match[](#if-you-add-multiple-filters-you-can-choose-to-have-all-or-any-of-the-conditions-match "Direct link to if-you-add-multiple-filters-you-can-choose-to-have-all-or-any-of-the-conditions-match")
...
```
WHERE (
  (pages.source) IN ('bigbytes_demo', 'bigbytes_documentation')
...
### If you want to include multiple values in your filter, just hit `enter` between each value entry in your list[](#if-you-want-to-include-multiple-values-in-your-filter-just-hit-enter-between-each-value-entry-in-your-list "Direct link to if-you-want-to-include-multiple-values-in-your-filter-just-hit-enter-between-each-value-entry-in-your-list")
...
```
WHERE (
  (pages.source) = 'bigbytes_demo'
   OR (pages.source) = 'bigbytes_documentation'
)

```

### To learn about the types of filters we have available, check out the filters reference doc.[](#to-learn-about-the-types-of-filters-we-have-available-check-out-the-filters-reference-doc "Direct link to To learn about the types of filters we have available, check out the filters reference doc.")

Check out our [filters reference doc here](/references/filters) to see a list of all available filters and their uses.

## Adding filters in the Explore view[](#adding-filters-in-the-explore-view "Direct link to Adding filters in the Explore view")

There are a couple of ways that you can add filters in the Explore view.

### Adding a filter from within the `Filters` tab[](#adding-a-filter-from-within-the-filters-tab "Direct link to adding-a-filter-from-within-the-filters-tab")
...
### Adding a filter from the sidebar[](#adding-a-filter-from-the-sidebar "Direct link to Adding a filter from the sidebar")
...
### Adding a filter from the results table[](#adding-a-filter-from-the-results-table "Direct link to Adding a filter from the results table")
...
### Adding nested filters[](#adding-nested-filters "Direct link to Adding nested filters")
...
## Adding filters to your dashboard[](#adding-filters-to-your-dashboard "Direct link to Adding filters to your dashboard")

There are a couple of ways that you can add filters to your Dashboards.

### Adding temporary filters to your dashboard[](#adding-temporary-filters-to-your-dashboard "Direct link to Adding temporary filters to your dashboard")
...
#### Adding temporary filters using the `add filters` button[](#adding-temporary-filters-using-the-add-filters-button "Direct link to adding-temporary-filters-using-the-add-filters-button")
...
#### `Cross filtering` your dashboard using values in your tiles[](#cross-filtering-your-dashboard-using-values-in-your-tiles "Direct link to cross-filtering-your-dashboard-using-values-in-your-tiles")
...
### Adding saved filters to your dashboard[](#adding-saved-filters-to-your-dashboard "Direct link to Adding saved filters to your dashboard")
...
2. If you want, you can adjust which tiles the filter is applied to by clicking on the `Tiles` tab.
<Frame>
...
1. Now, whenever someone opens the dashboard, they'll see your saved filters applied!
<Frame>
  <img src="/images/guides/dashboard-filters-saved-517f21a3d5aebe75b0635e30955f342a.png" alt=""/>
</Frame>

1. And if they want to drill-down into the data, they can always change the filters by clicking on the filter and adjusting the values.
<Frame>
...
### Some things worth mentioning about dashboard filters[](#some-things-worth-mentioning-about-dashboard-filters "Direct link to Some things worth mentioning about dashboard filters")

#### Sharing your dashboard with overrides[](#sharing-your-dashboard-with-overrides "Direct link to Sharing your dashboard with overrides")
...
#### You can easily see which dashboard tiles have which filters applied to them[](#you-can-easily-see-which-dashboard-tiles-have-which-filters-applied-to-them "Direct link to You can easily see which dashboard tiles have which filters applied to them")
...
#### Dashboard filters override filters applied in a saved chart[](#dashboard-filters-override-filters-applied-in-a-saved-chart "Direct link to Dashboard filters override filters applied in a saved chart")
...
#### Dashboard filters autocomplete[](#dashboard-filters-autocomplete "Direct link to Dashboard filters autocomplete")
