...
Deploy Bigbytes to your cloud provider using Terraform.

Cloud providers currently supported with Bigbytes Terraform scripts:
...
Clone Bigbytes’s
[Terraform template repository](https://github.com/getbigbytes/bigbytes-terraform-templates):

```bash
git clone https://github.com/getbigbytes/bigbytes-terraform-templates.git
```
