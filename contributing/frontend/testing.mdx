...
description: "Making Bigbytes invincible so that nothing can break it, not even itself."
icon: "swords"
---
...
[development environment](https://docs.getbigbytes.com/contributing/development-environment).
- Make sure [user authentication](https://docs.getbigbytes.com/production/authentication/overview) is enabled.
...
If you are running into issues with the app and would like to report it, you can tell us about it either on [GitHub](https://github.com/getbigbytes/bigbytes/issues/new/choose) or [Slack](https://www.getbigbytes.com/chat).
