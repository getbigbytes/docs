---
title: "Alerts"
description: Alerts enable you to receive notifications via email or Slack when the value of a saved chart meets your specified conditions.
---

At the scheduled time, Bigbytes will run the query and check the results. If the first value in the results set meets the alerting condition, the alert will be sent. This notification will continue to be sent if the condition is true until it is manually disabled or deleted.

You can create or select an existing saved chart, add an alert to it, and tell Bigbytes when you’d like the send out your update. You can set up as many alerts to a saved chart as you like, and if you make any changes to the content, Bigbytes will update the alert the next time they’re sent. Alerts can be sent to an email address or into Slack (assuming your org has [added Slack](/guides/adding-slack-integration)).
...
## Enabling alerts[](#enabling-alerts "Direct link to Enabling alerts")

Email alerts are available on all Bigbytes Cloud plans.

To set up Slack, an organization admin will have to [add the Slack integration](/guides/adding-slack-integration).

## Creating an alert[](#creating-an-alert "Direct link to Creating an alert")

Only users with [admin, developer or edit access](/references/roles) can create alerts. To create an alert, click on the three-dot menu in the top-right corner of your chart, then click on `Alerts`.

![](/images/guides/alert-three-dot-menu-7192397e3627e22de65ed2302a51f52b.png)
...
![](/images/guides/alert-create-new-modal-8e6d293745b72d2cc054641d9756c2ae.png)

### Setup[](#setup "Direct link to Setup")

Once you click on `Create new`, you'll be brought to a configuration screen for your new alert.

![](/images/guides/configure-alert-f29504d4a210ce6cd5032da60abda234.png)
...
* **Run frequency**: This is the frequency at which Bigbytes runs a query to check your data for changes. (You will be notified if the conditions on the latest value are met) . All times for the scheduler are in UTC.
...
## Editing and deleting your alerts[](#editing-and-deleting-your-alerts "Direct link to Editing and deleting your alerts")
...
<Frame>
  <img src="/images/guides/edit-delete-alert-b472792647c64e6b61cff99cfd66a0d2.png" alt=""/>
</Frame>
...
<Frame>
  <img src="/images/guides/private-slack-channel-e4c4bcf0137dbbf8cdae4439251fc9af.png" alt=""/>
</Frame>



<Info>
You must add the Bigbytes slack bot into the private Slack channel for it to be able to post alert results.
</Info>
