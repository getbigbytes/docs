...
Terraform will perform the following actions:
  ...
  + resource "azurerm_application_gateway" "network" {
      ...
      + location                    = "westus2"
      + name                        = "bigbytes-data-prep-production-app-gateway"
      + private_endpoint_connection = (known after apply)
      + resource_group_name         = "bigbytes-data-prep-production"

      + backend_address_pool {
          + fqdns        = []
          + id           = (known after apply)
          + ip_addresses = (known after apply)
          + name         = "bigbytes-data-prep-production-backend-pool"
        }

      + backend_http_settings {
          + cookie_based_affinity               = "Disabled"
          + id                                  = (known after apply)
          + name                                = "bigbytes-data-prep-production-http-setting"
      ...
      + frontend_ip_configuration {
          + id                            = (known after apply)
          + name                          = "bigbytes-data-prep-production-frontend-ip-config"
      ...
      + frontend_port {
          + id   = (known after apply)
          + name = "bigbytes-data-prep-production-frontend-port"
          + port = 80
        }

      + gateway_ip_configuration {
          + id        = (known after apply)
          + name      = "bigbytes-data-prep-production-ip-configuration"
          + subnet_id = (known after apply)
        }

      + http_listener {
          + frontend_ip_configuration_id   = (known after apply)
          + frontend_ip_configuration_name = "bigbytes-data-prep-production-frontend-ip-config"
          + frontend_port_id               = (known after apply)
          + frontend_port_name             = "bigbytes-data-prep-production-frontend-port"
          + host_names                     = []
          + id                             = (known after apply)
          + name                           = "bigbytes-data-prep-production-listener"
          + protocol                       = "Http"
      ...
      + request_routing_rule {
          ...
          + backend_address_pool_name  = "bigbytes-data-prep-production-backend-pool"
          + backend_http_settings_id   = (known after apply)
          + backend_http_settings_name = "bigbytes-data-prep-production-http-setting"
          + http_listener_id           = (known after apply)
          + http_listener_name         = "bigbytes-data-prep-production-listener"
          + id                         = (known after apply)
          + name                       = "bigbytes-data-prep-production-routing-rule"
          + priority                   = 10
  ...
  + resource "azurerm_container_group" "container_group" {
      ...
      + location            = "westus2"
      + name                = "bigbytes-data-prep-production"
      ...
      + container {
          ...
          + memory   = 1.5
          + name     = "bigbytes-data-prep-production-container"
          ...
          + volume {
              ...
              + read_only            = false
              + share_name           = "bigbytes-data-prep-production-data"
              + storage_account_key  = (sensitive value)
              + storage_account_name = "bigbytesdataprepstorage"
            }
        }
    }
  ...
  + resource "azurerm_network_profile" "containergroup_profile" {
      ...
      + id                              = (known after apply)
      + location                        = "westus2"
      + name                            = "bigbytes-data-prep-production-profile"
      + resource_group_name             = "bigbytes-data-prep-production"

      + container_network_interface {
          + name = "bigbytes-data-prep-production-nic"
  ...
  + resource "azurerm_network_security_group" "nsg-aci" {
      + id                  = (known after apply)
      + location            = "westus2"
      + name                = "bigbytes-data-prep-production-nsg-aci"
      + resource_group_name = "bigbytes-data-prep-production"
      + security_rule       = [
          + {
              + access                                     = "Allow"
  ...
  + resource "azurerm_network_security_group" "nsg-public" {
      + id                  = (known after apply)
      + location            = "westus2"
      + name                = "bigbytes-data-prep-production-nsg-public"
      + resource_group_name = "bigbytes-data-prep-production"
      + security_rule       = [
          + {
              + access                                     = "Allow"
  ...
  + resource "azurerm_public_ip" "public_ip" {
      ...
      + ip_version              = "IPv4"
      + location                = "westus2"
      + name                    = "bigbytes-data-prep-production-public-ip"
      + resource_group_name     = "bigbytes-data-prep-production"
      + sku                     = "Standard"
      + sku_tier                = "Regional"
    }
  ...
  + resource "azurerm_storage_share" "container_share" {
      ...
      + name                 = "bigbytes-data-prep-production-data"
      + quota                = 100
  ...
  + resource "azurerm_subnet" "sn-aci" {
      ...
      + virtual_network_name                           = "bigbytes-data-prep-production"
