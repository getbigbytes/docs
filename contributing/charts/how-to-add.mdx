...
Add a new type in [`bigbytes/data_preparation/models/widget/constants.py`](https://github.com/getbigbytes/bigbytes/blob/master/bigbytes/data_preparation/models/widget/constants.py):
...
Add a new type in [`bigbytes/frontend/interfaces/ChartBlockType.ts`](https://github.com/getbigbytes/bigbytes/blob/master/bigbytes/frontend/interfaces/ChartBlockType.ts):
...
In the file `bigbytes/frontend/components/ChartBlock/constants.ts`,
...
file `bigbytes/frontend/interfaces/ChartBlockType.ts`,:
...
in the file `bigbytes/data_preparation/models/widget/constants.py`:
...
In the file `bigbytes/frontend/interfaces/ChartBlockType.ts`, add the following:
...
add the following information into the file `bigbytes/frontend/components/ChartBlock/constants.ts`:
...
In the file `bigbytes/data_preparation/models/widget/__init__.py`,
...
In the file `bigbytes/frontend/components/ChartBlock/ChartController.tsx`,
