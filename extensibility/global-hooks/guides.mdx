...
sidebarTitle: "Setup"
description: "Follow this step by step guide on creating a global hook in Bigbytes."
icon: "webhook"
---
...
<img
  alt="Penguin Fishing"
  src="https://github.com/getbigbytes/assets/blob/main/penguin_fishing.gif?raw=True"
/>

### <b>Step 1: Navigate to the Global Hooks UI</b>
1. Log in to your Bigbytes account.
<Note>
If you are new to Bigbytes, follow these steps to enable Global Hooks:
