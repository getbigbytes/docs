...
icon: "pipe-section"
"og:image": "https://github.com/getbigbytes/assets/blob/main/orchestration-overview.gif?raw=true"
---

<Frame>
  <img
    alt="Bigbytes orchestration"
    src="https://github.com/getbigbytes/assets/blob/main/orchestration-overview.gif?raw=true"
  />
</Frame>
...
![Pipelines](https://github.com/getbigbytes/assets/blob/main/pipelines/pipelines-index.jpg?raw=true)
...
![Pipeline runs](https://github.com/getbigbytes/assets/blob/main/pipelines/pipeline-runs.jpg?raw=true)
...
![Pipeline detail](https://github.com/getbigbytes/assets/blob/main/pipelines/pipeline-detail.jpg?raw=true)
...
![Trigger create](https://github.com/getbigbytes/assets/blob/main/pipelines/trigger-create.jpg?raw=true)
...
![Trigger detail](https://github.com/getbigbytes/assets/blob/main/pipelines/trigger-detail.jpg?raw=true)
...
![Pipeline detail runs](https://github.com/getbigbytes/assets/blob/main/pipelines/pipeline-detail-runs.jpg?raw=true)
...
![Pipeline detail logs](https://github.com/getbigbytes/assets/blob/main/pipelines/pipeline-detail-logs.jpg?raw=true)
...
<img
  alt="Monitoring"
  src="https://github.com/getbigbytes/assets/blob/main/monitoring.jpg?raw=true"
/>
...
## Variable storage
Bigbytes automatically persists the output of block runs on disk. You can specify the path or the storage for block output variables
in the following ways.
* Specify the data directory path via `BIGBYTES_DATA_DIR` environment variable. If you use Bigbytes docker image, this environment
  variable is set to `/home/src/bigbytes_data` by default.
* If the `BIGBYTES_DATA_DIR` environment variable is not set, you can set the `variables_dir` path in project's metadata.yaml. Here is
  an example:
  ```yaml
  variables_dir: /home/src/bigbytes_data
  ```
...
```bash
bigbytes clean-cached-variables [project_path]
```

## Cache block output in memory

By default, Bigbytes persists block output on disk. In pipeline's metadata.yaml, you have the option to configure the pipeline to cache
