...
1. Run Bigbytes and mount the secrets as a volume in Docker.
...
1. Create a new `.env` file in your Bigbytes project folder with the following values:
...
1. Run Bigbytes using Docker and set the environment variable `GOOGLE_APPLICATION_CREDENTIALS`.
