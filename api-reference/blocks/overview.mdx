...
<ResponseField name="all_upstream_blocks_executed" type="boolean">
  ...
  <ResponseField name="executor_type" type="string">
    ...
    See the [Kubernetes config](/production/configuring-production-settings/compute-resource#2-set-executor-type-and-customize-the-compute-resource-of-the-bigbytes-executor) page for more details.
  </ResponseField>
