...
<img alt="requirements" src="https://github.com/getbigbytes/assets/blob/main/requirements.png?raw=True" />
...
214e1155f5c3   bigbytes/data   "python bigbytes/comm…"   5 seconds ago   Up 2 seconds             bigbytes_server_run_6f8d367ac405
```

The container name in the above sample output is
`bigbytes_server_run_6f8d367ac405`.
...
![create new pipeline](https://github.com/getbigbytes/assets/blob/main/create-new-pipeline.gif?raw=True)
...
![](https://github.com/getbigbytes/assets/blob/main/scratchpad.gif?raw=True)
...
![load data](https://github.com/getbigbytes/assets/blob/main/load-data.gif?raw=True)
...
![Transform data](https://github.com/getbigbytes/assets/blob/main/transform-data.gif?raw=True)
...
![Train model](https://github.com/getbigbytes/assets/blob/main/train-model.gif?raw=True)
...
```bash pip
bash bigbytes run demo_project titanic_survivors
```
...
![](https://github.com/getbigbytes/assets/blob/main/execute-pipeline-button.png?raw=True)
...
[Slack](https://www.getbigbytes.com/chat).
