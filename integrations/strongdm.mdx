...
To effectively connect on a StrongDM Resource inside Bigbytes's docker, you may need to add:
<br/>
...
To install StrongDM CLI tool, first access Bigbytes's docker bash and execute the installation script:
```bash
