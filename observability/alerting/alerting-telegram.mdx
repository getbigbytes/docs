...
3. Update Bigbytes project settings
...
## Update Bigbytes project settings
...
1. Open the Bigbytes tool in your browser (e.g. http://localhost:6789/).
...
For `pipeline_run_url`, the default host is `http://localhost:6789`. You can specify `BIGBYTES_PUBLIC_HOST` to be
...
|                                                                                                        |
| ------------------------------------------------------------------------------------------------------ |
| ![Telegram](https://github.com/getbigbytes/assets/blob/main/third-party/telegram-message-run-alert.jpg?raw=true) |
