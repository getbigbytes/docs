...
Open the file named `io_config.yaml` at the root of your Bigbytes project and enter the following:
...
default:
  trino:
    ...
    host: 127.0.0.1
    http_headers:
      X-Something: 'bigbytes=power'
    http_scheme: http
    password: bigbytes1337                        # Optional
    port: 8080
    schema: core_data
...
Read these [instructions](https://github.com/getbigbytes/bigbytes/blob/master/bigbytes_integrations/bigbytes_integrations/destinations/trino/README.md#run-trino-locally)
