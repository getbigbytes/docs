...
description: "These are the fundamental concepts that Bigbytes uses to operate."
...
A Bigbytes project forms the basis for all the work you do in Bigbytes. It contains the code for your data pipelines, blocks, and other project-specific data. You can think of it like a GitHub repo— it can even track your [file history, too](https://docs.getbigbytes.com/getting-started/file-versions#where-are-the-file-versions-stored).
...
Each pipeline is represented by a YAML file (here's an [example](https://github.com/getbigbytes/demo_etl_pipeline/blob/master/pipelines/etl_demo/metadata.yaml)) in the `pipelines` folder under the Bigbytes project directory.

<img
  alt="Pipeline"
  src="https://github.com/getbigbytes/assets/blob/main/overview/bigbytes-build.gif?raw=True"
/>
...
[data loader block](https://github.com/getbigbytes/demo%5Fetl%5Fpipeline/blob/master/data%5Floaders/load%5Fdataset.py)
...
- Does a table exist (e.g. `bigbytes.users_v1`)?
...
```bash
from bigbytes.orchestration.run_status_checker import check_status
...
<img
  alt="Log detail"
  src="https://github.com/getbigbytes/assets/blob/main/logs/log-detail.png?raw=true"
/>

Logs are stored on disk wherever Bigbytes is running. However, you can configure
