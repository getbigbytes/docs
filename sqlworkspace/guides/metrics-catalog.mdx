...
Existing Bigbytes users don’t need to do anything to get started! Spotlight features use your existing semantic layer and metrics definitions, so you can get started today.
...
To pre-select a time field in the explore view, simply define the default settings in your Bigbytes `.yml` files.

#### Set a default time dimension on a table level in your Bigbytes .yml file[](#set-a-default-time-dimension-on-a-table-level-in-your-bigbytes-yml-file "Direct link to Set a default time dimension on a table level in your Bigbytes .yml file")
...
#### Set a default time dimension on a metric level in your Bigbytes .yml file[](#set-a-default-time-dimension-on-a-metric-level-in-your-bigbytes-yml-file "Direct link to Set a default time dimension on a metric level in your Bigbytes .yml file")
