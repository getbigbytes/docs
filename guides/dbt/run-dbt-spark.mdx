...
1. Build a Bigbytes docker image with Spark following the instructions given at
[Build Bigbytes docker image with Spark environment](/integrations/spark-pyspark#1-build-bigbytes-docker-image-with-spark-environment).

2. Run the following command in your terminal to start Bigbytes using docker:
```bash
docker run -it --name bigbytes_spark -p 6789:6789 -v $(pwd):/home/src mage_spark \
...
<img
  ...
  src="https://github.com/getbigbytes/assets/blob/main/pyspark-scratchpad-results.png?raw=True"
/>

4. Click the `Terminal` icon on the right side of the Bigbytes UI, and create a dbt
...
<img
  ...
  src="https://github.com/getbigbytes/assets/blob/main/dbt-spark-testing-results.png?raw=True"
/>
