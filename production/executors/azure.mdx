...
If your Bigbytes app is deployed on Microsoft Azure with Bigbytes’s [Terraform](https://github.com/getbigbytes/bigbytes-terraform-templates/tree/master/azure)
