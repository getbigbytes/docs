...
Each pipeline in Bigbytes has a `metadata.yaml` configuration file located in the
...
[environment variable](https://docs.getbigbytes.com/development/variables/environment-variables).
</Note>
