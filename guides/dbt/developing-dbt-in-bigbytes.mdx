---
title: "Develop dbt in Bigbytes"
sidebarTitle: "Getting started"
icon: "sliders"
description: "Learn how to develop your favorite dbt models in Bigbytes."
---
...
<Step title="Create standard pipeline">
    ...
    - Go to the Bigbytes dashboard and click the button
...
<Step title="Add dbt model block to pipeline">
    ...
    ![](https://github.com/getbigbytes/assets/blob/main/dbt/add-dbt-model.gif?raw=true)
</Step>
<Step title="Edit my_first_dbt_model">
    ...
    ![](https://github.com/getbigbytes/assets/blob/main/dbt/dbt-preview.gif?raw=true)
    ...
    ![](https://github.com/getbigbytes/assets/blob/main/dbt/run-model.png?raw=true)
